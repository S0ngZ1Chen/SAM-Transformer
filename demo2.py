...
if __name__ == '__main__':
    ...
    model_path = os.path.join(base_dir,'run','train','2024-04-09-11-34-55','best_mae_trainval_0.pth.tar')
    ...
    if not os.path.exists(os.path.join(base_dir,'run','eval')):
        os.mkdir(os.path.join(base_dir,'run','eval'))
    ...
    for image_name in tqdm(image_names):
        ...
        plt.savefig(os.path.join(base_dir,'run','eval',image_name+'.png'),dpi=300)
